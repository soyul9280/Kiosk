...
import com.example.kioskt.databinding.FragmentHamburgerBinding


class Hamburger_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val linearLayouts = listOf(
            binding.baconBurger,
            binding.bulgogiBurger,
            binding.cheeseBurger,
            binding.shrimpBurger,
            binding.chickenBurger,
            binding.hamburger
        )
